    ...
    <div className="flex flex-col rounded-xl border border-border bg-card">
      ...
      >
        <input
          ...
          className="flex-1 rounded-lg border border-border bg-background px-4 py-2 text-sm text-foreground placeholder:text-muted focus:border-accent focus:outline-none"
          disabled={isLoading}
        />
        <button
          type="submit"
  ...
  return (
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
      <div className={`text-sm ${isUser ? "max-w-[80%]" : "max-w-full w-full"}`}>
        ...
        {isUser ? (
          <div className="rounded-2xl rounded-tr-sm bg-accent px-4 py-2.5 text-white whitespace-pre-wrap">
            {message.content}
          </div>
        ) : message.content ? (
          <div
            className="rounded-2xl rounded-tl-sm border border-border bg-card px-4 py-3 prose-custom prose-sm max-w-none"

      ...
      >
        ...
        <div className="flex flex-col items-center gap-0.5">
          <button
            ...
            className="cursor-pointer rounded-xl bg-accent px-4 py-2 text-sm font-medium text-background transition-all hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:translate-y-0"
          >
            发送
          </button>
  ...
  return (
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
      <div className={`text-sm ${isUser ? "max-w-[80%]" : "max-w-full w-full"}`}>
        ...
        {isUser ? (
          <div className="select-text cursor-text rounded-xl bg-accent px-4 py-2.5 text-background whitespace-pre-wrap">
            {message.content}
          </div>
        ) : message.content ? (
          <div
            className="select-text cursor-text rounded-xl border border-border bg-card px-4 py-3 prose-custom prose-sm max-w-none"

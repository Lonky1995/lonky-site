  ...
  return (
    <AnimatedCard delay={index * 0.1}>
      ...
      <a
        ...
        className="mb-4 flex items-center gap-2 rounded-xl border border-accent/20 bg-accent/5 px-4 py-2.5 text-sm font-medium text-accent transition-colors hover:bg-accent/10"
      >

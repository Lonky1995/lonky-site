...
export function YouTubeCard({
  ...
  return (
    <AnimatedCard delay={index * 0.1}>
      ...
      {/* Subscribe CTA */}
      <a
        href="https://t.me/whathappenednow"
        target="_blank"
        rel="noopener noreferrer"
        className="mb-4 flex items-center gap-2 rounded-none border border-accent/20 bg-accent/5 px-4 py-2.5 text-sm font-medium text-accent transition-colors hover:bg-accent/10"
      >
        ...
        <span className="text-xs text-muted">@whathappenednow</span>
      </a>

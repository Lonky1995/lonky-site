      ...
      <div className="rounded-xl border border-border bg-card p-6 space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl border border-border bg-background px-3 py-2.5 text-sm text-foreground placeholder:text-muted focus:border-accent focus:outline-none"
            autoComplete="off"
          />
        </div>
        ...
        <button
          ...
          className="w-full rounded-xl bg-accent py-2.5 text-sm font-medium text-background transition-opacity hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed"
        >
          开始分析
        </button>
      </div>

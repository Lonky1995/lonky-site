      ...
      <div className="rounded-none border border-border bg-card p-6 space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full rounded-none border border-border bg-background px-3 py-2.5 text-sm text-foreground placeholder:text-muted focus:border-accent focus:outline-none"
            autoComplete="off"
          />
        </div>
        ...
        {error && (
          <div className="rounded-none bg-red-500/10 border border-red-500/20 px-4 py-3 text-sm text-red-400">
            {error}
          </div>
        )}
        ...
        <button
          ...
          className="w-full rounded-none bg-accent py-2.5 text-sm font-medium text-background transition-opacity hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed"
        >
          开始分析
        </button>
      </div>

      <div className="rounded-none border border-yellow-500/20 bg-yellow-500/5 px-4 py-3 text-xs leading-relaxed text-yellow-400/80">
